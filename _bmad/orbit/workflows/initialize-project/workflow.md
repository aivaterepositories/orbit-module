...
description: Set up new project in ORBIT with Dual Engine tracking and Discover phase setup
...
```
LOAD: {project-root}/_bmad/orbit/workflows/initialize-project/steps/step-01-project-setup.md
```
